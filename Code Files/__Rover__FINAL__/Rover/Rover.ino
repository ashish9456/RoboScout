...
const int flash_pin = 2; //pin for camera flash
...
{
  //If the arm is unstable, it is due to the varying values sent by the potentiometer
  //Algorithm: if(new value > old value + 10) 
  /*           {
                 values[i] = new value;
               }
  consequence: delay in response by the arm. So, it's a tradeoff between stability and response time.
  */
